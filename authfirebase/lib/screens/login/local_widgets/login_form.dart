...
class _LoginFormState extends State<LoginForm> {
    ...
    try {
      ...
      switch (type) {
        ...
        case LoginType.google:
          returnValue = await currentUser.loginUserWithGoogle();
          break;
        default:
      }
  ...
  // Widget signInGoogleFacebookButton(Size size, BuildContext context) {
  //   return Row(
    ...
    return ShadowContainer(
      child: Column(
        children: <Widget>[
          ...
          // signInGoogleFacebookButton(deviceSize,context),
          _googleButton(),
        ],
      ),
    );
